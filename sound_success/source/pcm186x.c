			     ...
			     struct snd_soc_dai *dai)
{
	...
	u8 pcm_cfg = 0;
	 ...
	 dev_warn(component->dev, " skj pcm186x_hw_params start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_hw_params end\n"); //  by skj
...
/*
	...
	case SND_SOC_DAIFMT_DSP_A:
		priv->tdm_offset += 1;
		fallthrough;
		//DSP_A uses the same basic config as DSP_B except we need to shift the TDM output by one BCK cycle
...
*/
	dev_warn(component->dev, " skj pcm186x_set_fmt end\n"); //  by skj
				...
				unsigned int rx_mask, int slots, int slot_width)
{
	...
	dev_warn(component->dev, " skj pcm186x_set_tdm_slot start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_set_tdm_slot end\n"); //  by skj
				  ...
				  unsigned int freq, int dir)
{
	...
	dev_warn(component->dev, " skj pcm186x_set_dai_sysclk start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_set_dai_sysclk end. freq is %d\n", freq); //  by skj
...
static int pcm186x_power_on(struct snd_soc_component *component)
{
	...
	dev_warn(component->dev, " skj pcm186x_power_on start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_power_on end\n"); //  by skj
...
static int pcm186x_power_off(struct snd_soc_component *component)
{
	...
	dev_warn(component->dev, " skj pcm186x_power_off start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_power_off end\n"); //  by skj
				  ...
				  enum snd_soc_bias_level level)
{
	...
	dev_warn(component->dev, " skj pcm186x_set_bias_level start\n"); //  by skj
	...
	dev_warn(component->dev, " skj pcm186x_set_bias_level end\n"); //  by skj
		  ...
		  struct regmap *regmap)
{
	...
	dev_warn(dev, " skj pcm186x_probe start\n"); //  by skj
	...
	dev_warn(dev, " skj pcm186x_probe end\n"); //  by skj
